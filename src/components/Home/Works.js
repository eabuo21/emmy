  ...
  return (
    ...
    >
      <section className="context-section  flex flex-col gap-y-[30px] justify-center items-center   mx-auto">
        <h1 className="text-xl font-lato font-medium text-stone-300 text-center   md:text-4xl mt-6">
          Works and Projects completed
        </h1>
        <p className="text-stone-500 text-base font-medium font-sans   md:text-xl  text-center    md:w-[80%]">
