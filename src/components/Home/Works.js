...
export default function works() {
  return (
    <div
      className="   w-full h-[fixed]  flex flex-col p-6  gap-y-[30px] justify-start items-start      bg-neutral-900 bg-opacity-65  shadow-2xl  rounded-[45px]  
    md:w-[1200px]  md:h-[fixed]   mx-auto "
    >
      ...
      <section className="tabs-section  h-[fixed] w-full  p-2">
        <Tabs />
      </section>
    </div>
  );
