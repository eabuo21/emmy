...
export default function Hero() {
  return (
    <div className="main-container  grid grid-cols-1  mt-[30px] gap-y-[30px] gap-x-[30px]  md:flex md:flex-row  w-full justify-start items-start px-4    md:px-[2rem] mb-9">
      <section className="profiler-container  shadow-2xl  rounded-[45px]   w-full h-[400px] bg-neutral-900 bg-opacity-65  flex flex-col justify-center items-center  p-2   gap-y-[20px]  md:p-4 md:w-[500px] ">
        <div
      ...
      <section className="profiler-carousel-container  flex flex-col gap-y-[30px] justify-start items-start px-2    w-full h-[fixed] bg-transparent       md:w-[1200px] ">
        <section className="profiler-carousel-container  p-6  flex flex-col gap-y-[20px] justify-center items-start px-2    w-full h-[fixed] bg-neutral-900 bg-opacity-65  shadow-2xl  rounded-[45px]   md:px-[2rem] md:w-full  md:h-[500px] ">
          ...
          <p className="text-base  text-stone-500  font-sans    font-thin   md:text-xl   md:w-[90%]">
