...
export default function Pricing() {
  return (
    <div className=" w-full flex flex-col justify-start items-center gap-y-[40px] h-[fixed] bg-neutral-900 bg-opacity-65 shadow-[40px] rounded-[45px] mx-auto lg:w-[1200px] md:px-4 md:h-[fixed] p-3 md:p-5 mb-9 ">
